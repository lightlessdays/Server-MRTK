...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityPlayspace_set_Rotation_m95242BDC3485C2DCC7C054EE25E53D6C551E5296 (Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4  ___value0, const RuntimeMethod* method);
...
IL_010c:
	{
		...
		MixedRealityPlayspace_set_Position_mDDB3ACE01D85ACB2215FD269341CB84573BA362D(L_40, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_m95242BDC3485C2DCC7C054EE25E53D6C551E5296(L_41, /*hidden argument*/NULL);
		// if (CameraCache.Main.transform.position != Vector3.zero)
		Camera_tC44E094BAB53AFC8A014C6F9CFCE11F4FC38006C * L_42;
		L_42 = CameraCache_get_Main_m0F0CC751FE952F0372CA003210913CFC143DEA67(/*hidden argument*/NULL);
		NullCheck(L_42);
...
IL_0154:
	{
		...
		L_51 = CameraCache_get_Main_m0F0CC751FE952F0372CA003210913CFC143DEA67(/*hidden argument*/NULL);
		NullCheck(L_51);
...
IL_000e:
	...
	{ // begin try (depth: 1)
		...
		L_2 = CameraCache_get_Main_m0F0CC751FE952F0372CA003210913CFC143DEA67(/*hidden argument*/NULL);
		...
		L_5 = CameraCache_get_Main_m0F0CC751FE952F0372CA003210913CFC143DEA67(/*hidden argument*/NULL);
		...
		L_11 = CameraCache_get_Main_m0F0CC751FE952F0372CA003210913CFC143DEA67(/*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityCameraSystem__cctor_m3858CF8DEC76C088DB2CCB220D886D8B0DCE555E (const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
